...
#resp1 = fetch(URL1)
#text1 = io.BytesIO((resp1.arrayBuffer()).to_py())
...
# TASK  2
# Standardize te data in <cod>X</code> then reassto the va<code>X</code>sing the transform provided below.
...
# Set the parameter test_size to  0.2 and random_state to 2. The training data and test data should be assigned to the following labels.
